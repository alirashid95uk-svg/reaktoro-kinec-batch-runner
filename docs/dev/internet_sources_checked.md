...
| KineticsSolver class reference | https://reaktoro.org/api/classReaktoro_1_1KineticsSolver.html | `KineticsSolver.solve` reacts a state over a time interval in seconds. | Kinetic execution uses explicit solver calls and time units. |
